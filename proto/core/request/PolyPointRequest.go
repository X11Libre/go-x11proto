...
// Coordinate mode for point lists (PolyPoint/PolyLine/FillPoly).
const (
	CoordModeOrigin   = 0
	CoordModePrevious = 1
)
...
func (r *PolyPointRequest) WriteInto(writer *base.RequestWriter) error {
	writer.SetOpcode(opcode.PolyPoint)
