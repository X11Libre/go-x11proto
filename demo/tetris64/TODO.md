...
[x] add current resolution / theme to main/frame window title   -- frame title is now "C64 TETRIS - <RES> / <theme>" (e.g. "FHD / color"), updated on every +/-/C change (window recreated)
